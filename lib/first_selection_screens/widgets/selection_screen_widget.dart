...
class SelectionScreenWidgetState extends State<SelectionScreenWidget>with WidgetsBindingObserver {
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: GFRadio (
                                ...
                                activeIcon: Icon(Icons.check, size: 14,color: Colors.white,),
                                value: "Rider",
                                groupValue: val,
                                onChanged: (value) {
                                  setState(() {
                                ...
                                inactiveIcon: Icon(Icons.check, size: 14,),
