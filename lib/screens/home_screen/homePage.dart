     ...
     return SafeArea(
       child: Scaffold(
           ...
           body:  BottomSheetBar(
               ...
               controller: _bsbController,height: 400,
               expandedBuilder: (scrollController) => _bsbController.isCollapsed ? Container() : DestinationPage(onPressed:(){_bsbController.collapse();}, key: null ,),
